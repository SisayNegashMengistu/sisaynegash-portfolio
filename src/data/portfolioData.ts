...
export const projectsData: Project[] = [
  ...
  // newly added project
  {
    ...
    description:
      "This project develops an integrated web-based system combining staff information, clearance, and complaint management into one secure platform.",
...
export const personalInfo = {
  ...
  description:"Software Engineer, Lecturer, and Full-Stack Developer building scalable, secure, and innovative software while mentoring future engineers.",
  location: "Dire Dawa, Ethiopia",
